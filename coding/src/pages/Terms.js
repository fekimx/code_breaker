...
return (
    ...
    <div class="container">
        ...
        <h2 className="text-2xl font-medium text-secondary mt-4 mb-12 text-center">
            ...
            <p>
                    BY CLICKING THE REGISTER BOX AND CREATING AND ACCOUNT, THE USER INDICATES ACCEPTANCE AND AGREES TO THESE TERMS. IF THE INDIVIDUAL ACCEPTING THESE TERMS DOES NOT AGREE WITH THESE TERMS, SUCH INDIVIDUAL MUST NOT ACCEPT THESE TERMS AND MAY NOT USE THE PLATFORM.
                </p>
                <p>1. PLATFORM.
